...
import { MODEL_BASES, type NeuralDifficulty } from "./difficulty";
...
export class ComputerController {
  ...
  load(difficulty:NeuralDifficulty="normal"){return this.channel(difficulty).load(difficulty)}
  choose(state:GameState,difficulty:NeuralDifficulty="normal",progress?:(done:number,total:number)=>void){return this.channel(difficulty).choose(state,difficulty,progress)}
