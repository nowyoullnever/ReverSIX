...
- 둘째 수의 뒤집기를 마친 가상 보드에서, 같은 6개 이상 연속선 안에 이번 턴 두 신규 돌이 함께 포함되면 금지합니다. 해당 칸만 🚫 표시합니다.
...
1. '같은 SIX 연결'은 **최대 연속선 전체**로 해석합니다. 7개 이상 연결의 양끝에 신규 돌이 있어도 금지합니다. 겹치는 6칸 창 단위로 나누지 않습니다.
