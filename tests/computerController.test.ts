...
it("excludes CHECK moves that cannot survive the turn",()=>{
  ...
  const state={...createGame(),board,turnStartBoard,currentPlayer:"white" as const,turn:15,moveNumberInTurn:2 as const,firstPlacedStone:23,turnPlacements:[23],checkBy:"black" as const,revision:30};
